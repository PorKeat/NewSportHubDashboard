...
const UpdateAthleteComponent = ({ athlete, OnSuccess }) => {
      ...
      >
        {({ setFieldValue, handleChange }) => (
          <Form className="form mt-6 space-y-2">
            ...
            <div className="mx-auto mt-8 m-0">
              <label htmlFor="body" className="block text-md mb-2">
                Biography
              </label>
